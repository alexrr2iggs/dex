...
```typescript
import { $s } from "https://deno.land/x/sced@v1.1.1/src/mod.ts";
...
```typescript
import { $$ } from "https://deno.land/x/sced@v1.1.1/src/mod.ts";
...
```typescript
import { $b } from "https://deno.land/x/sced@v1.1.1/src/mod.ts";
